...
class MoviedbPageCrawler(PageCrawler):
    FIELD_NAMES = get_field_names("moviedb")
...
#         entry_dict = {"ID": MoviedbPageCrawler._get_id(url), "Name": name}
...
#                 match attr:
#                     case "atf-wrapper-bg":
#                         entry_dict["Plot"] = MoviedbPageCrawler._get_plot(e)
#                         entry_dict["Rating"] = MoviedbPageCrawler.get_imdb_rating(e)
#                         entry_dict["Genres"] = MoviedbPageCrawler._get_genres(e)
#                         entry_dict["Runtime"] = MoviedbPageCrawler._get_run_time(e)
#                         entry_dict["Directors"] = MoviedbPageCrawler._get_directors(e)
#                         rdate_fallback = MoviedbPageCrawler._get_release_date_fallback(
#                             e
#                         )
#                     case "title-cast":
#                         entry_dict["Cast"] = MoviedbPageCrawler._get_cast(e)
#                     case "Details":
#                         entry_dict["ReleaseDate"] = (
#                             MoviedbPageCrawler._get_release_date(e) or rdate_fallback
#                         )
#                         entry_dict["OriginCountries"] = MoviedbPageCrawler._get_origins(
#                             e
#                         )
#                         entry_dict["Languages"] = MoviedbPageCrawler._get_languages(e)
#         return entry_dict
